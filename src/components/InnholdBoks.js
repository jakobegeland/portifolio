...
function InnholdBoks() {
  ...
  const in2000_tekst_2 ="Løsningen er utviklet for Android-enheter og tilbyr blant annet en database med over 100 turer, karttjeneste med bratthet- og topografisk filter, regional skredvarsling, værvarsling på nærområder, visualisering av tur på kart, og mulighet til å lagre og fjerne favoritturer.";
  ...
  const in3010_tekst_2 ="Ved å utvikle en app som skal bli brukt for å loggføre over en lenger tidsperiode, og som skal hjelpe å gjøre det enklere for mennesker i alle aldre med bedre helse og økt livskvalitet. I tillegg til å hjelpe å kommunisere eget sykdomsbilde videre til leger, venner og familie.";
